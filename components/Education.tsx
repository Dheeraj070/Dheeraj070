...
import { GraduationCap, Award, BookOpen, Users, Cpu, FileCode, ExternalLink, ShieldCheck } from 'lucide-react';
    ...
    <section id="education" className="py-20">
      <div className="flex flex-col gap-16">
        ...
        <div id="certifications" className="w-full">
          ...
          {/* Credly Badges Banner */}
          <div className="mb-8">
            <a
              href="https://www.credly.com/users/dheerajreddy070"
              target="_blank"
              rel="noopener noreferrer"
              className="glass-card p-6 md:p-8 rounded-2xl border border-white/5 hover:border-orange-500/50 transition-all group flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden"
            >
              ...
              <div className="flex items-center gap-6 relative z-10">
                <div className="w-16 h-16 rounded-full bg-orange-500/10 flex items-center justify-center text-orange-500 shrink-0 border border-orange-500/20 group-hover:scale-110 transition-transform">
                  <ShieldCheck size={32} />
                </div>
                <div>
                  <h3 className="text-xl md:text-2xl font-bold text-white mb-2 group-hover:text-orange-400 transition-colors">Verified Digital Badges</h3>
                  <p className="text-slate-400 max-w-xl">
                    View my official verified badges and professional certifications on Credly.
                  </p>
                </div>
              </div>

              <div className="flex items-center gap-2 px-6 py-3 bg-orange-600 text-white font-bold rounded-xl hover:bg-orange-500 transition-colors shadow-lg shadow-orange-900/20 shrink-0 relative z-10">
